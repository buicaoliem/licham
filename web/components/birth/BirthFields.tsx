...
import { type BirthPlaceTz, isValidTimeZone } from "@/lib/birth/time";
...
export function parseBirth(s: BirthFormState): { value?: ParsedBirth; errors: Partial<Record<BirthField, string>> } {
  ...
  return { value: { lich: s.lich, year, month, day, isLeapMonth: s.lich === "am" && s.amLeap, hour, minute, timeUnknown: s.timeUnknown, place }, errors };
}
