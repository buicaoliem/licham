      ...
      <div className="ch-wrap ch-main ch-layout">
        <div className="ch-stack">
          ...
          <div className="box">
            <div className="box-h">
              <span className="rule" />
              <span className="t">Kim Lâu là gì</span>
              <span className="rule" />
            </div>
            <p>
          ...
          <div className="box">
            <div className="box-h">
              <span className="rule" />
              <span className="t">Tam hợp và tứ hành xung 12 con giáp</span>
              <span className="rule" />
            </div>
            <div className="cols2">
              <div>
          ...
          <div className="box">
            <div className="box-h">
              <span className="rule" />
              <span className="t">Xem theo con giáp</span>
              <span className="rule" />
            </div>
            <div className="chips">
              {CHI_LIST.map((c) => {
